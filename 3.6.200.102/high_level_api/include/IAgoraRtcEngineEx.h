...
class IRtcEngineEventHandlerEx : public IRtcEngineEventHandler {
 public:
  ...
  using IRtcEngineEventHandler::onTrapezoidAutoCorrectionFinished;
...
public:
     ...
     * @param connection The current Rtc connection.
     * @param mode The remote video setup mode: add, remove.If you add the same view twice,
     ...
     * - < 0: Failure.
     */
    virtual int setupRemoteVideoEx(const VideoCanvas& canvas, const RtcConnection& connection, VIDEO_VIEW_SETUP_MODE mode) = 0;
    ...
    * - < 0: Failure.
    */
    virtual int setupLocalVideoEx(const VideoCanvas& canvas, VIDEO_VIEW_SETUP_MODE mode) = 0;
    ...
    virtual int applyVideoEncoderMirrorToRemoteEx(uid_t uid, VIDEO_MIRROR_MODE_TYPE mirrorMode, const RtcConnection& connection) = 0;

    virtual int applyVideoOrientationToRemoteEx(uid_t uid, VIDEO_ORIENTATION orientation, const RtcConnection& connection) = 0;
